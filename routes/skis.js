...
const skiData = express.Router();
const bodyParser = require("body-parser");
const mongoose = require("mongoose");

skiData.use(bodyParser.urlencoded({ extended: false }));
skiData.use(bodyParser.json());
...
// skiData.get("/manufactures", (req,res) => {
//   Manufacture.find({})
...
// skiData.delete("/manufactures", (req, res) => {
...
// skiData.post("/manufactures", (req, res) => {
//   Manufacture.create({
//   name: req.query.name,
...
// skiData.post("/manufactures/:name", function(req, res) {
//   Ski.create({
//     name: req.query.name,
...
// skiData.get("/manufactures/:name", function(req, res) {
